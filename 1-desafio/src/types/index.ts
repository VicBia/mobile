...
export interface MarketData {
    ...
    market_cap_change_24h: number
    market_cap_change_percentage_24h: number
    price_change_24h_in_currency: unknown
    ...
    price_change_percentage_14d_in_currency: unknown
    price_change_percentage_30d_in_currency: unknown
    price_change_percentage_60d_in_currency: unknown
    price_change_percentage_200d_in_currency: unknown
    price_change_percentage_1y_in_currency: unknown
    market_cap_change_24h_in_currency: unknown
    market_cap_change_percentage_24h_in_currency: unknown
    total_supply: number
    max_supply: number
    circulating_supply: number
    last_updated: string
